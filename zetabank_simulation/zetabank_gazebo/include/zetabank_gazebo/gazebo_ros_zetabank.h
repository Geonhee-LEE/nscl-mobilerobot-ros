...
#ifndef GAZEBO_ROS_ZETABANK_H_
#define GAZEBO_ROS_ZETABANK_H_
...
#define GET_ZB_DIRECTION 0
#define ZB_DRIVE_FORWARD 1
#define ZB_RIGHT_TURN    2
#define ZB_LEFT_TURN     3

class GazeboRosZetabank
{
 public:
  GazeboRosZetabank();
  ~GazeboRosZetabank();
