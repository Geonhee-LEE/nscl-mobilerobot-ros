...
void sensorStateMsgCallback(const nscl_msgs::SensorState::ConstPtr &msg)
{
  if (msg->battery > 24.0)
  ...
  if (msg->button == nscl_msgs::SensorState::BUTTON0)
    setButtonDiagnosis(diagnostic_msgs::DiagnosticStatus::OK, "BUTTON 0 IS PUSHED");
  else if (msg->button == nscl_msgs::SensorState::BUTTON1)
...
{
  ros::init(argc, argv, "nscl_diagnostic");
  ros::NodeHandle nh;
