...
class NSCLControl{
    ...
    public:
    	...
    	NSCLNavigation msclnav;
        
        nscl_msgs::CmdInfo current_cmdInfo; //command information for sending to the top
        ...
        // Callback func
        bool cmdInfoCb(nscl_msgs::CmdInfo::Request  &req,nscl_msgs::CmdInfo::Response &res);
